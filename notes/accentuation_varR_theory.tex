...
\begin{equation}
  ...
  =(1-\E R)^2+\Var(R)
\end{equation}
motivates the code approximation
\begin{equation}
  \frac{\E E_{\rm acc}}{S}
  \simeq
  (1-R_{\rm det})^2+\Var_{\rm current}(R).
  \label{eq:Eacc-correction}
\end{equation}
This is enabled by \texttt{include\_var\_R=True}.
...
\end{equation}
This is enabled by \texttt{include\_delta\_correction=True}.
